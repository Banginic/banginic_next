    ...
    >
      <div className=" grid mt-5 lg:w-[70%] text-3xl px-10">
        ...
        <div className=" md:w-[70%] lg:w-[80%] mt-4 md:static top-24  md:px-0 z-10 ">
          ...
          >
            We build scalable, speedy, stylish and custom web solutions that
            last for ever. We turn your ideas into high-performing web
            applications.
          </p>
          <div>
            <CTAHero />
      ...
      >
        <Image
          className="lg:pl-14   md:static right-0 w-[450px]  md:w-[600px] borde lg:h-[400px] 2xl:h-[450px] 2xl:w-[650px]"
          alt={"./placeholder.png"}
          src={hero_image}
          width={500}
          height={500}
